...
function ConvState(e, t, i, n) {
    ...
    function(e) {
        e.fn.convform = function(t) {
            var i = e.extend(!0, {}, {
                    placeHolder: botPlaceHolder || "Type Here / Select Option From Above",
    ...
    var e = $(".conv-form-wrapper").convform({placeHolder: botPlaceHolder});
    console.log(e)
});
var rollbackTo = !1,
    originalState = !1;
...
$("#chat_seven_form").submit(function(e) {
    e.preventDefault();
